		...
		try{
			...
			if ($connection->connect_errno!=0){
				...
				if ($OK==true){
					...
					if ($connection->query("INSERT INTO incomes VALUES (NULL, '$userId',(SELECT id FROM incomes_category_assigned_to_users WHERE user_id ='$userId' AND name ='$category'),'$amount','$date','$comment')")){
						$_SESSION['addIncomeOK'] = true;
...
<head>
	<meta charset="utf-8" />
	<title>Dodaj przychód- budżet osobisty</title>
	<meta name="description" content="Dodaj przychód - Aplikacja do prowadzenbia budżetu osobistego." />
		...
		<nav class="navbar navbar-expand-md p-1">
			...
			<div class="collapse navbar-collapse" id="mainmenu">
				...
				<ul class="navbar-nav mx-auto">
					...
					<li class="nav-item active"><a class="nav-link">Dodaj przychód</a></li>
				...
				<form method ="post">
					<div class ="row justify-content-center">
						<div class="col-12 background form">
							...
							<div class="row mt-3">		
								<div class ="col-8 offset-4 col-sm-7 offset-sm-5 col-md-5 offset-1 incomes">
									<fieldset>

<?php
	...
	if (!isset($_SESSION['addExpenseOK'])) {
		
		header('Location: index.php'); 
		exit(); 
	}else{
		unset($_SESSION['addExpenseOK']);
	}
			...
			<div class="container">
				<div class="row text-center ">
					<div class="col-12 background">
						...
						<p> <strong>  Dodano nowy wydatek do Twojego budżetu osobistego! </strong> </p>
						
						<div class="col-10 offset-1">
						<a href="expenses.php" class="nextStep" role="button"> Dodaj kolejny wydatek</a>
						</div>			
					</div>
				</div>
			</div>
